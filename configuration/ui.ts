...
export const FOOTER_MESSAGE: string = `Customized Credit Card Helper AI by Guru Balamurugan`;
export const CLEAR_BUTTON_TEXT: string = `[CLEAR BUTTON TEXT]`;
export const PAGE_TITLE: string = `[PAGE TITLE]`;
export const PAGE_DESCRIPTION: string = `Chat with ${Credit-Card-Specialist}, ${Guru}'s AI assistant.`;
